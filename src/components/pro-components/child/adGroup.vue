...
<template>
  <div>
      ...
      <div v-if="selected=='module1'" class="campaign" style="margin-top:20px">
        <div class="campaign-create">
          ...
          <div class="campaign-card-items clearfix">
            <div
              v-for="(item, index) in cardTab"
              :key="index"
              class="campaign-card"
              :class="{active:cardSelect==item.key}"
              @click="activeCard(item.key)"
            >
    ...
    <div
      class="panel_moduler"
      style="min-width: 1048px;padding-top: 24px; padding-bottom: 24px;text-align:right;"
    >
